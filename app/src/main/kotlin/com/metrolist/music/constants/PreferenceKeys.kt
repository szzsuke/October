...
val SpotifyLoggedInKey = booleanPreferencesKey("spotifyLoggedIn")
val SpotifyClientIdKey = stringPreferencesKey("spotifyClientId")
val AccountTypeKey = stringPreferencesKey("accountType")
val UserProfilePicUriKey = stringPreferencesKey("userProfilePicUri")
val CustomAccountNameKey = stringPreferencesKey("customAccountName")
val CustomAccountUsernameKey = stringPreferencesKey("customAccountUsername")
val CustomProfilePicPathKey = stringPreferencesKey("customProfilePicPath")
val EntryPathKey = stringPreferencesKey("entryPath") // "SPOTIFY" or "GOOGLE"
val GoogleIdentityAttachedKey = booleanPreferencesKey("googleIdentityAttached")
val PrimaryConnectionKey = stringPreferencesKey("primaryConnection") // "YTMUSIC" or "GOOGLE"
val LastBackupHashKey = stringPreferencesKey("lastBackupHash")
...
// Onboarding and Auth Keys
val IsOnboardedKey = booleanPreferencesKey("is_onboarded")
val HasPromptedNotificationPermissionKey = booleanPreferencesKey("has_prompted_notification_permission")
val JustLoggedInKey = booleanPreferencesKey("just_logged_in")
