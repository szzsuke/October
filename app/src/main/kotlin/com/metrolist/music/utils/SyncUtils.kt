...
class SyncUtils @Inject constructor(
    ...
    private suspend fun executeFullSync() = withContext(Dispatchers.IO) {
        ...
        try {
            ...
            // Podcasts and episodes decommissioned in October
            ...
            result.onSuccess { page ->
                try {
                    val remotePlaylists = page.items.filterIsInstance<PlaylistItem>()
                        ...
                        .filterNot { it.id.startsWith("RD") }
                        .filterNot { it.title.contains("Mix", ignoreCase = true) || it.title.contains("Radio", ignoreCase = true) }
                        .reversed()
                        .distinctBy { it.id }
            ...
            result.onSuccess { page ->
                try {
                    val songs = page.songs
                        .filterNot { it.isEpisode }
                        .filterNot { it.musicVideoType == "MUSIC_VIDEO_TYPE_UGC" }
