...
fun NavGraphBuilder.navigationBuilder(
    ...
    composable(Screens.WelcomeLogin.route) {
        val context = androidx.compose.ui.platform.LocalContext.current
        com.metrolist.music.ui.screens.auth.WelcomeLoginScreen(
            navController = navController,
            onContinue = {
                navController.navigate(Screens.Home.route) {
                    popUpTo(Screens.WelcomeLogin.route) {
                        inclusive = true
                    }
            ...
            onGoogleSignInClick = {
                navController.navigate("login_webview")
            },
    ...
    composable("login") {
        val (spotifyLoggedIn) = com.metrolist.music.utils.rememberPreference(com.metrolist.music.constants.SpotifyLoggedInKey, defaultValue = false)
        com.metrolist.music.ui.screens.auth.WelcomeLoginScreen(
            navController = navController,
            isFromSettings = true,
            ...
            onSpotifySignInClick = { navController.navigate("spotify_login?fromSettings=true") }
        )
    }

    composable(
        route = "login_webview?email={email}",
        arguments = listOf(
            navArgument("email") {
                type = NavType.StringType
                nullable = true
        ...
        LoginScreen(navController, initialEmail = email)
    }
    ...
    composable(
        route = "spotify_login?fromSettings={fromSettings}",
        arguments =
            listOf(
        ...
        SpotifyLoginScreen(navController, isFromSettings = fromSettings)
    }

    composable("spotify_login") {
        SpotifyLoginScreen(navController, isFromSettings = false)
    }
            ...
            onContinue = {
                coroutineScope.launch {
                    context.safeDataStoreEdit { settings ->
                        settings[HasPromptedNotificationPermissionKey] = true
                    }
                }
                navController.navigate(Screens.Home.route) {
                    popUpTo(Screens.WelcomeLogin.route) {
