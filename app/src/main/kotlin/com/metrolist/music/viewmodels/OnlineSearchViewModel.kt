        ...
        if (summaryPage == null) {
            YouTube
                ...
                .onSuccess { page ->
                    ...
                    val cleanSummaries = resolvedSummaries.filterNot { s ->
                        ...
                        summary.copy(items = summary.items.filterNot { it is com.metrolist.innertube.models.PodcastItem || it is com.metrolist.innertube.models.EpisodeItem })
                    }
                    val resolvedPage = page.copy(summaries = cleanSummaries)
